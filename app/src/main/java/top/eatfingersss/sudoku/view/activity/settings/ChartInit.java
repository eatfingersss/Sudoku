...
import top.eatfingersss.sudoku.framework.view.williamchart.ChartsFragment;


public class ChartInit extends AppCompatActivity {
                ...
                try {
                    ...
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(
                            "http://play.google.com/store/apps/details?id=" +
                                    "https://play.google.com/store/apps/details?id=com.db.williamchart")));
                }
                return true;
            default:
